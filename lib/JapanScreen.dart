                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const Text("Japan", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Colors.white),),
                      ],
                    ),
                  ],
                ),
                      ...
                      Row(
                        children: [
                          Padding(
                            ...
                            child: InkWell(onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>const JapanExams()));
                            },
                              child: Column(
                                children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.only(left: 30),
                            child: InkWell(onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>const JapanScholarships()));
                            },
                              child: Column(
                                children: [
                      ...
                      Row(
                        children: [
                          ...
                          Padding(
                            ...
                            child: InkWell(onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>const JapanColleges()));
                            },
                              child: Column(
                                children: [
